...
3. TRIQS/solid_dmft jobflow recipe + DMFTResult parser. **(P3.3 — shipped (model + mock + Wannier gate + optional real skip); pairing → performance_score is P3.4; see docs/phase3-p33-dmft.md)**
