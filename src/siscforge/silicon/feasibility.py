...
def score_si_feasibility(
    ...
    *,
    ...
    # Prefer film–immediate-template mismatch (not worst buffer–Si on single buffers).
    ...
    membrane_flag, membrane_note = membrane_transfer_heuristic(
        ...
        # Use effective path |mismatch| so multilayer soft penalties are visible.
    ...
    if membrane_flag:
        # Dedicated membrane fields carry the recommendation; do not dilute
        # chemical_flags (P2.2 chemical/process-window contract).
