...
**Next**: **P3.6** — mixed AL acquisition (P3.5 oxygen-vacancy enumeration is this PR, pending merge; see `docs/phase3-p35-oxygen-vacancy.md`)
...
- Oxygen-vacancy structure generation (**P3.5** — this PR, pending merge; see `docs/phase3-p35-oxygen-vacancy.md`).
