...
| **P3.3** | TRIQS / solid_dmft → `DMFTResult` | **Scaffold + controlled launcher** — model + gate + mock + parser + optional invoke; production U/J/β residual — `docs/phase3-p33-dmft.md` |
...
| **P3.6** | Mixed conventional/unconventional AL | **Done** — `docs/phase3-p36-mixed-al.md` |
